...
const UserInput = (props) => {
    ...
    const submitHandler = (event) => {
        event.preventDefault();//Sayfayı reload etmez submitte
    ...
    return (<form onSubmit={submitHandler} className={classes.form}>
        ...
        <div className={classes['input-group']}>
            ...
            <p>
                ...
                <input value={userInput['duration']} onChange={(event) => inputChangeHandler('duration', event.target.value)} type="number" id="" />
            </p>
        </div>
